...
const ASSETS = {
  bg: {
    ...
    mistVillage:     'assets/bg/mist-village.png',
    villageInterior: 'assets/bg/village-interior.png',
    bambooForest:    'assets/bg/bamboo-forest.png',
    bossArena:       'assets/bg/boss-arena.png',
    chapterCard:     'assets/bg/chapter-card.png',
    // 後續章節新增專屬手繪 PNG（已不再共用 + 染色）
    foxfire:         'assets/bg/foxfire.png',
    foxfireArena:    'assets/bg/foxfire-arena.png',
    southMountain:   'assets/bg/south-mountain.png',
    southArena:      'assets/bg/south-arena.png',
    rift:            'assets/bg/rift.png',
    riftArena:       'assets/bg/rift-arena.png',
    nuwa:            'assets/bg/nuwa.png',
    nuwaArena:       'assets/bg/nuwa-arena.png',
    finalArena:      'assets/bg/final-arena.png',
    finalArenaBoss:  'assets/bg/final-arena-boss.png',
    modernStreet:    'assets/bg/modern-street.png',
    // 以下尚無圖時 fallback 到 modernStreet（檔案到位後改路徑即可）
    modernClassroom: 'assets/bg/modern-classroom.png',
    modernHome:      'assets/bg/modern-home.png',
    endingUnnamed:   'assets/bg/ending-unnamed-card.png',
    yaojingScroll:   'assets/bg/yaojing-scroll.png',
    museumNight:     'assets/bg/museum-night.png',
    bambooFar:       'assets/bg/bamboo-far.png',
    bambooMid:       'assets/bg/bamboo-mid.png',
    bambooNear:      'assets/bg/bamboo-near.png',
  },
  ...
  char: {
    ruoli: {
      normal:     'assets/char/ruoli/normal.png',
      surprised:  'assets/char/ruoli/surprised.png',
      worried:    'assets/char/ruoli/worried.png',
      determined: 'assets/char/ruoli/determined.png',
      ch3Normal:  'assets/char/ruoli/ch3-attired-normal.png',
      ch3Determined: 'assets/char/ruoli/ch3-attired-determined.png',
      ch5Normal:  'assets/char/ruoli/ch5-attired-normal.png',
      ch5Determined: 'assets/char/ruoli/ch5-attired-determined.png',
      finaleNormal: 'assets/char/ruoli/finale-normal.png',
      finaleDetermined: 'assets/char/ruoli/finale-determined.png',
    },
    ruoliModern: {
      normal:  'assets/char/ruoli-modern/normal.png',
      curious: 'assets/char/ruoli-modern/curious.png',
      falling: 'assets/char/ruoli-modern/falling.png',
    },
    bailing: {
      smile: 'assets/char/bailing/smile.png',
      sly:   'assets/char/bailing/sly.png',
    },
    xuance: {
      normal:    'assets/char/xuance/normal.png',
      stern:     'assets/char/xuance/stern.png',
      surprised: 'assets/char/xuance/surprised.png',
    },
    chiyu: {
      normal:   'assets/char/chiyu/normal.png',
      focused:  'assets/char/chiyu/focused.png',
      friendly: 'assets/char/chiyu/friendly.png',
    },
    nuwa: {
      apparition: 'assets/char/nuwa/apparition.png',
      sad:         'assets/char/nuwa/sad.png',
      normal:      'assets/char/nuwa/apparition.png',
    },
    classmate: {
      normal:  'assets/char/classmate/normal.png',
      worried: 'assets/char/classmate/worried.png',
    },
    mother: {
      normal: 'assets/char/mother/normal.png',
    },
    curator: {
      normal: 'assets/char/curator/normal.png',
    },
  },
  battle: {
    ruoli:     'assets/battle/ruoli.png',
    boar:      'assets/battle/boar.png',
    leap:      'assets/battle/leap.png',
    wisp:      'assets/battle/wisp.png',
    boss:      'assets/battle/boss.png',
    // 新增專屬手繪 PNG（不再用 tint 區分）
    foxfire:   'assets/battle/foxfire.png',
    yaobing:   'assets/battle/yaobing.png',
    guidiao:   'assets/battle/guidiao.png',
    qiongqi:   'assets/battle/qiongqi.png',
    guardian:  'assets/battle/guardian.png',
    finalboss: 'assets/battle/finalboss.png',
    jiuwei:    'assets/battle/jiuwei.png',
  },
  bossIntro: {
    boss:      'assets/battle/boss-intro/wuyao-hero.png',
    jiuwei:    'assets/battle/boss-intro/jiuwei-hero.png',
    qiongqi:   'assets/battle/boss-intro/qiongqi-hero.png',
    guidiao:   'assets/battle/boss-intro/guidiao-hero.png',
    guardian:  'assets/battle/boss-intro/guardian-hero.png',
    finalboss: 'assets/battle/boss-intro/finalboss-hero.png',
  },
  ui: {
    seal: 'assets/ui/seal.png',
    items: {
      phone: 'assets/ui/items/phone.png',
      studentId: 'assets/ui/items/student-id.png',
      sketchbook: 'assets/ui/items/sketchbook.png',
      scrollFrag: 'assets/ui/items/scroll-yaojing.png',
      yaoliPill: 'assets/ui/items/yaoli-pill.png',
      hpDrop: 'assets/ui/items/hp-drop.png',
    },
    touch: {
      jump: 'assets/ui/touch/jump.png',
      attack: 'assets/ui/touch/attack.png',
      roll: 'assets/ui/touch/roll.png',
      yaoli: 'assets/ui/touch/yaoli.png',
    },
    yaoliIcons: {
      inkshade:   'assets/ui/yaoli/ink.png',
      moonlight:  'assets/ui/yaoli/moon.png',
      azureflame: 'assets/ui/yaoli/flame.png',
      windplume:  'assets/ui/yaoli/wind.png',
      spiritbind: 'assets/ui/yaoli/bind.png',
    },
  },
};
...
// ============================================================
const YAOLI = {
  inkshade:  { id:'inkshade',  name:'墨影', cost:35, color:'#1a1612', icon:'assets/ui/yaoli/ink.png',   desc:'遠距水墨斬擊', dmgMul:2.5, basicDmg:12 },
  moonlight: { id:'moonlight', name:'月華', cost:40, color:'#d8e0f0', icon:'assets/ui/yaoli/moon.png',  desc:'回血展盾',     dmgMul:1.6, basicDmg:11, heal:18 },
  azureflame:{ id:'azureflame',name:'青焰', cost:30, color:'#f5601a', icon:'assets/ui/yaoli/flame.png', desc:'近身燃燒',     dmgMul:2.2, basicDmg:13, burn:true },
  windplume: { id:'windplume', name:'風羽', cost:25, color:'#5ad0e0', icon:'assets/ui/yaoli/wind.png',  desc:'高速二段',     dmgMul:2.0, basicDmg:11, fast:true },
  spiritbind:{ id:'spiritbind',name:'靈縛', cost:45, color:'#a060d8', icon:'assets/ui/yaoli/bind.png',  desc:'束縛敵人',     dmgMul:1.8, basicDmg:11, stun:true },
};
...
// ============================================================
const AUDIO_BGM = {
  title:        'assets/audio/bgm/title.wav',
  museum:       'assets/audio/bgm/museum.wav',
  mistVillage:  'assets/audio/bgm/mistVillage.wav',
  foxfire:      'assets/audio/bgm/foxfire.wav',
  south:        'assets/audio/bgm/south.wav',
  rift:         'assets/audio/bgm/rift.wav',
  nuwa:         'assets/audio/bgm/nuwa.wav',
  battle:       'assets/audio/bgm/battle.wav',
  final:        'assets/audio/bgm/final.wav',
  ending:       'assets/audio/bgm/ending.wav',
};
const AUDIO_SFX = {
  inkStroke:    'assets/audio/sfx/ink-stroke.wav',
  jump:         'assets/audio/sfx/jump.wav',
  roll:         'assets/audio/sfx/roll.wav',
  hit:          'assets/audio/sfx/hit.wav',
  hitYaoli:     'assets/audio/sfx/hit-yaoli.wav',
  playerHurt:   'assets/audio/sfx/player-hurt.wav',
  uiStamp:      'assets/audio/sfx/ui-stamp.wav',
  uiPage:       'assets/audio/sfx/ui-page.wav',
  victory:      'assets/audio/sfx/victory.wav',
  defeat:       'assets/audio/sfx/defeat.wav',
  bossRoar:     'assets/audio/sfx/boss-roar.wav',
  bossWarning:  'assets/audio/sfx/boss-warning.wav',
};
const Audio = {
