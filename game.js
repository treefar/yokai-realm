...
const ASSETS = {
  bg: {
    // 既有 6 張水墨手繪 PNG
    museum:          'assets/bg/museum.webp?v=20260510-preload3',
    mistVillage:     'assets/bg/mist-village.webp?v=20260510-preload3',
    villageInterior: 'assets/bg/village-interior.webp?v=20260510-preload3',
    bambooForest:    'assets/bg/bamboo-forest.webp?v=20260510-preload3',
    bossArena:       'assets/bg/boss-arena.webp?v=20260510-preload3',
    chapterCard:     'assets/bg/chapter-card.webp?v=20260510-preload3',
    // 後續章節新增專屬手繪 PNG（已不再共用 + 染色）
    foxfire:         'assets/bg/foxfire.webp?v=20260510-preload3',
    foxfireArena:    'assets/bg/foxfire-arena.webp?v=20260510-preload3',
    southMountain:   'assets/bg/south-mountain.webp?v=20260510-preload3',
    southArena:      'assets/bg/south-arena.webp?v=20260510-preload3',
    rift:            'assets/bg/rift.webp?v=20260510-preload3',
    riftArena:       'assets/bg/rift-arena.webp?v=20260510-preload3',
    nuwa:            'assets/bg/nuwa.webp?v=20260510-preload3',
    nuwaArena:       'assets/bg/nuwa-arena.webp?v=20260510-preload3',
    finalArena:      'assets/bg/final-arena.webp?v=20260510-preload3',
    finalArenaBoss:  'assets/bg/final-arena-boss.webp?v=20260510-preload3',
    modernStreet:    'assets/bg/modern-street.webp?v=20260510-preload3',
    // 以下尚無圖時 fallback 到 modernStreet（檔案到位後改路徑即可）
    modernClassroom: 'assets/bg/modern-classroom.webp?v=20260510-preload3',
    modernHome:      'assets/bg/modern-home.webp?v=20260510-preload3',
    endingUnnamed:   'assets/bg/ending-unnamed-card.webp?v=20260510-preload3',
    yaojingScroll:   'assets/bg/yaojing-scroll.webp?v=20260510-preload3',
    museumNight:     'assets/bg/museum-night.webp?v=20260510-preload3',
    bambooFar:       'assets/bg/bamboo-far.webp?v=20260510-preload3',
    bambooMid:       'assets/bg/bamboo-mid.webp?v=20260510-preload3',
    bambooNear:      'assets/bg/bamboo-near.webp?v=20260510-preload3',
  },
  ...
  char: {
    ruoli: {
      normal:     'assets/char/ruoli/normal.webp?v=20260510-preload3',
      surprised:  'assets/char/ruoli/surprised.webp?v=20260510-preload3',
      worried:    'assets/char/ruoli/worried.webp?v=20260510-preload3',
      determined: 'assets/char/ruoli/determined.webp?v=20260510-preload3',
      ch3Normal:  'assets/char/ruoli/ch3-attired-normal.webp?v=20260510-preload3',
      ch3Determined: 'assets/char/ruoli/ch3-attired-determined.webp?v=20260510-preload3',
      ch5Normal:  'assets/char/ruoli/ch5-attired-normal.webp?v=20260510-preload3',
      ch5Determined: 'assets/char/ruoli/ch5-attired-determined.webp?v=20260510-preload3',
      finaleNormal: 'assets/char/ruoli/finale-normal.webp?v=20260510-preload3',
      finaleDetermined: 'assets/char/ruoli/finale-determined.webp?v=20260510-preload3',
    },
    ruoliModern: {
      normal:  'assets/char/ruoli-modern/normal.webp?v=20260510-preload3',
      curious: 'assets/char/ruoli-modern/curious.webp?v=20260510-preload3',
      falling: 'assets/char/ruoli-modern/falling.webp?v=20260510-preload3',
    },
    bailing: {
      smile: 'assets/char/bailing/smile.webp?v=20260510-preload3',
      sly:   'assets/char/bailing/sly.webp?v=20260510-preload3',
    },
    xuance: {
      normal:    'assets/char/xuance/normal.webp?v=20260510-preload3',
      stern:     'assets/char/xuance/stern.webp?v=20260510-preload3',
      surprised: 'assets/char/xuance/surprised.webp?v=20260510-preload3',
    },
    chiyu: {
      normal:   'assets/char/chiyu/normal.webp?v=20260510-preload3',
      focused:  'assets/char/chiyu/focused.webp?v=20260510-preload3',
      friendly: 'assets/char/chiyu/friendly.webp?v=20260510-preload3',
    },
    nuwa: {
      apparition: 'assets/char/nuwa/apparition.webp?v=20260510-preload3',
      sad:         'assets/char/nuwa/sad.webp?v=20260510-preload3',
      normal:      'assets/char/nuwa/apparition.webp?v=20260510-preload3',
    },
    classmate: {
      normal:  'assets/char/classmate/normal.webp?v=20260510-preload3',
      worried: 'assets/char/classmate/worried.webp?v=20260510-preload3',
    },
    mother: {
      normal: 'assets/char/mother/normal.webp?v=20260510-preload3',
    },
    curator: {
      normal: 'assets/char/curator/normal.webp?v=20260510-preload3',
    },
  },
  battle: {
    ruoli:     'assets/battle/ruoli.webp?v=20260510-preload3',
    boar:      'assets/battle/boar.webp?v=20260510-preload3',
    leap:      'assets/battle/leap.webp?v=20260510-preload3',
    wisp:      'assets/battle/wisp.webp?v=20260510-preload3',
    boss:      'assets/battle/boss.webp?v=20260510-preload3',
    // 新增專屬手繪 PNG（不再用 tint 區分）
    foxfire:   'assets/battle/foxfire.webp?v=20260510-preload3',
    yaobing:   'assets/battle/yaobing.webp?v=20260510-preload3',
    guidiao:   'assets/battle/guidiao.webp?v=20260510-preload3',
    qiongqi:   'assets/battle/qiongqi.webp?v=20260510-preload3',
    guardian:  'assets/battle/guardian.webp?v=20260510-preload3',
    finalboss: 'assets/battle/finalboss.webp?v=20260510-preload3',
    jiuwei:    'assets/battle/jiuwei.webp?v=20260510-preload3',
  },
  bossIntro: {
    boss:      'assets/battle/boss-intro/wuyao-hero.webp?v=20260510-preload3',
    jiuwei:    'assets/battle/boss-intro/jiuwei-hero.webp?v=20260510-preload3',
    qiongqi:   'assets/battle/boss-intro/qiongqi-hero.webp?v=20260510-preload3',
    guidiao:   'assets/battle/boss-intro/guidiao-hero.webp?v=20260510-preload3',
    guardian:  'assets/battle/boss-intro/guardian-hero.webp?v=20260510-preload3',
    finalboss: 'assets/battle/boss-intro/finalboss-hero.webp?v=20260510-preload3',
  },
  ui: {
    seal: 'assets/ui/seal.webp?v=20260510-preload3',
    items: {
      phone: 'assets/ui/items/phone.webp?v=20260510-preload3',
      studentId: 'assets/ui/items/student-id.webp?v=20260510-preload3',
      sketchbook: 'assets/ui/items/sketchbook.webp?v=20260510-preload3',
      scrollFrag: 'assets/ui/items/scroll-yaojing.webp?v=20260510-preload3',
      yaoliPill: 'assets/ui/items/yaoli-pill.webp?v=20260510-preload3',
      hpDrop: 'assets/ui/items/hp-drop.webp?v=20260510-preload3',
    },
    touch: {
      jump: 'assets/ui/touch/jump.webp?v=20260510-preload3',
      attack: 'assets/ui/touch/attack.webp?v=20260510-preload3',
      roll: 'assets/ui/touch/roll.webp?v=20260510-preload3',
      yaoli: 'assets/ui/touch/yaoli.webp?v=20260510-preload3',
    },
    yaoliIcons: {
      inkshade:   'assets/ui/yaoli/ink.webp?v=20260510-preload3',
      moonlight:  'assets/ui/yaoli/moon.webp?v=20260510-preload3',
      azureflame: 'assets/ui/yaoli/flame.webp?v=20260510-preload3',
      windplume:  'assets/ui/yaoli/wind.webp?v=20260510-preload3',
      spiritbind: 'assets/ui/yaoli/bind.webp?v=20260510-preload3',
    },
  },
};
...
// ============================================================
const YAOLI = {
  inkshade:  { id:'inkshade',  name:'墨影', cost:35, color:'#1a1612', icon:'assets/ui/yaoli/ink.webp?v=20260510-preload3',   desc:'遠距水墨斬擊', dmgMul:2.5, basicDmg:12 },
  moonlight: { id:'moonlight', name:'月華', cost:40, color:'#d8e0f0', icon:'assets/ui/yaoli/moon.webp?v=20260510-preload3',  desc:'回血展盾',     dmgMul:1.6, basicDmg:11, heal:18 },
  azureflame:{ id:'azureflame',name:'青焰', cost:30, color:'#f5601a', icon:'assets/ui/yaoli/flame.webp?v=20260510-preload3', desc:'近身燃燒',     dmgMul:2.2, basicDmg:13, burn:true },
  windplume: { id:'windplume', name:'風羽', cost:25, color:'#5ad0e0', icon:'assets/ui/yaoli/wind.webp?v=20260510-preload3',  desc:'高速二段',     dmgMul:2.0, basicDmg:11, fast:true },
  spiritbind:{ id:'spiritbind',name:'靈縛', cost:45, color:'#a060d8', icon:'assets/ui/yaoli/bind.webp?v=20260510-preload3',  desc:'束縛敵人',     dmgMul:1.8, basicDmg:11, stun:true },
};
